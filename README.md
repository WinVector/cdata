...
```
    ...
    ## [1] "table(`rquery_mat_24057916660461953997_0000000000`; AUC, R2)"

``` r
rstr(my_db, tab)
```

    ## table `rquery_mat_24057916660461953997_0000000000` spark_connection spark_shell_connection DBIConnection 
    ##  nrow: 1 
