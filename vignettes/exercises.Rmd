...
`cdata` also supplies a number of convenience functions for specifying common transforms, especially the fundamental cases of moving in out and our records that are exactly one row.
