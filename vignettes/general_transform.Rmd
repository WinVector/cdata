...
In `cdata` `1.0.5` or newer we can make things even easier and use a [conveneince function that combines these steps](https://winvector.github.io/cdata/reference/convert_records.html).
