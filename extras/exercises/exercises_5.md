...
In [this note]() we are going to use some [`tidyr`](https://CRAN.R-project.org/package=tidyr) data transform demonstration examples, and use them to demonstrate how to use the [`cdata`](https://CRAN.R-project.org/package=cdata) [`R`](https://www.r-project.org) data layout package.
