...
Full data not available, as link is dead. From [https://stats.idre.ucla.edu/stata/modules/reshaping-data-wide-to-long/](https://stats.idre.ucla.edu/stata/modules/reshaping-data-wide-to-long/) we can get the following data extract.  From this source we can extract the question:
...
(From: [https://github.com/tidyverse/tidyr/blob/master/demo/so-16032858.R](https://github.com/tidyverse/tidyr/blob/master/demo/so-16032858.R) , [r](http://stackoverflow.com/questions/16032858).)
