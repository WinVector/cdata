...
-   `pivotValuesToColumns()` and `unpivotValuesToRows()` (this writeup)
...
To make things easier to understand and remember, we introduce another wrapping function: `pivotValuesToColumns()`.
